...
<body>
  ...
  <form style="margin-bottom:10px;" class="" action="index-bonus.php" method="post">
  ...
  <div>
   ...
   <?php if (!$_POST || strpos($text, $_POST["nome"])==false) { echo "La mala parola ". $_POST['nome'] ." non è presente nel testo "; ?>
